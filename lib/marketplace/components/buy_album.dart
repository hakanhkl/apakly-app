...
class BuyAlbum extends StatefulWidget {
  Album album;
  BuyAlbum({
    required this.album,
    super.key,
  ...
  @override
  State<BuyAlbum> createState() => _BuyAlbumState();
}

class _BuyAlbumState extends State<BuyAlbum> {
                    ...
                    children: [
                      Padding(
                        ...
                        child: AspectRatio(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              widget.album.coverFileLocation!,
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      Column(
                          ...
                          children: [
                            ...
                            FutureBuilder<Artist>(
                                future: ArtistRequests.getArtistProfileInformation(widget.album.artist!.id!),
                          ...
                          Align(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.album.editions.toString(),
                                    style: const TextStyle(
                                      color: textColor,
                                      fontSize: fSize2,
                                      fontWeight: FontWeight.bold,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: (){
                            cartController.addItem(widget.album);
                          },
                          child: const Text(
                            'Add to Cart',
                            style: TextStyle(
