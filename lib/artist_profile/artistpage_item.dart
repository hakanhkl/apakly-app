...
class ArtistpageItem extends StatelessWidget {
  Item item;
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => MarketplaceItemPreview(id: item.id!)),
            );
          },
          child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            RichText(
                              ...
                              maxLines: 1,
                              text: TextSpan(
                                text: item.leftEditions! <= 50 ? 'Editions' : "limitiert auf",
                                style: const TextStyle(
                                  fontSize: fSize0,
                                  color: Colors.grey,
                                ),
